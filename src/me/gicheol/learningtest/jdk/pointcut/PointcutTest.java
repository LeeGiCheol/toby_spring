package me.gicheol.learningtest.jdk.pointcut;
...
public class PointcutTest {
    ...
    public void methodSignaturePointcut() throws  SecurityException, NoSuchMethodException {
        ...
        pointcut.setExpression("execution(public int me.gicheol.learningtest.jdk.pointcut.Target.minus(int,int) " +
        ...
        assertThat(pointcut.getClassFilter().matches(Target.class) &&
                                  pointcut.getMethodMatcher()
                                 .matches(Bean.class.getMethod("method"), null),
                                        is(false));
    }
